/**************************************************************************************************
  ...
  Revised:        $Date: 2010-07-23 11:11:28 -0700 (Fri, 23 Jul 2010) $
  Revision:       $Revision: 23117 $
...
extern uint32 macMcuPrecisionCount(void);
  ...
  #define CONVERT_320US_TO_MS_ELAPSED_REMINDER( x, y, z ) st(  \
                                                               \
...
void osalTimeUpdate( void )
{
  ...
  if ( tmp != previousMacTimerTick )
  {
    ...
    CONVERT_320US_TO_MS_ELAPSED_REMINDER( tmp, elapsedMSec, remUsTicks );
