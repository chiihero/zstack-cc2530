/**************************************************************************************************
  ...
  Revised:        $Date: 2010-09-09 09:46:48 -0700 (Thu, 09 Sep 2010) $
  Revision:       $Revision: 23706 $
...
#if defined (STARTEST)
  uint8 CskipRtrs[MAX_NODE_DEPTH+1] = {5,0,0,0,0,0};
  uint8 CskipChldrn[MAX_NODE_DEPTH+1] = {10,0,0,0,0,0};
#elif defined (TREETEST)
  uint8 CskipRtrs[MAX_NODE_DEPTH+1] = {1,1,1,1,1,0};
  uint8 CskipChldrn[MAX_NODE_DEPTH+1] = {2,2,2,2,2,0};
#else  
