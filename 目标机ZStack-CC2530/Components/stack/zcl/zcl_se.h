/**************************************************************************************************
  Filename:       zcl_SE.h
  Revised:        $Date: 2010-10-29 14:36:49 -0700 (Fri, 29 Oct 2010) $
  Revision:       $Revision: 24278 $
...
#define ATTRID_SE_CUR_PART_PROFILE_INT_START_TIME_DELIVERED ( 0x0005 | ATTRID_MASK_SE_ESP_HISTORICAL_CONSUMPTION )
#define ATTRID_SE_CUR_PART_PROFILE_INT_START_TIME_RECEIVED  ( 0x0006 | ATTRID_MASK_SE_ESP_HISTORICAL_CONSUMPTION )
#define ATTRID_SE_CUR_PART_PROFILE_INT_VALUE_DELIVERED      ( 0x0007 | ATTRID_MASK_SE_ESP_HISTORICAL_CONSUMPTION )
#define ATTRID_SE_CUR_PART_PROFILE_INT_VALUE_RECEIVED       ( 0x0008 | ATTRID_MASK_SE_ESP_HISTORICAL_CONSUMPTION )
