/***************************************************************************************************
  Filename:       MT_TASK.c
  Revised:        $Date: 2010-07-20 19:48:51 -0700 (Tue, 20 Jul 2010) $
  Revision:       $Revision: 23075 $
...
void MT_ProcessIncomingCommand( mtOSALSerialData_t *msg )
{
  ...
  switch ( msg->hdr.event )
  {
    ...
    case MT_SYS_APP_RSP_MSG:
      //len = SPI_0DATA_MSG_LEN + msg_ptr[DATALEN_FIELD]; //del by liren
      len = msg->hdr.status;          // add by liren
