/**************************************************************************************************
  ...
  Revised:        $Date: 2010-10-21 11:11:55 -0700 (Thu, 21 Oct 2010) $
  Revision:       $Revision: 24165 $
...
/* Minimum idle time, this macro is to prevent negative wakeup time.
 * See halSleepSetTimer().
 */
#define PM_MIN_IDLE_TIME      ((HAL_SLEEP_ADJ_TICKS * 64 / 671) + 1)
