...
const uint8 CODE macRadioDefsTxPwrBare[] =
{
  ...
  /*   2 dBm */   0xCC,   /* characterized as  1.7 dBm in datasheet */
  /*   1 dBm */   0xCC,
  ...
  /*  -4 dBm */   0x8C,   /* characterized as -4.1 dBm in datasheet */
  /*  -5 dBm */   0x8C,
  ...
  /* -11 dBm */   0x5C,
  /* -12 dBm */   0x4C,   /* characterized as -12.4 dBm in datasheet */
  /* -13 dBm */   0x4C,
  /* -14 dBm */   0x4C,
  ...
  /* -20 dBm */   0x0C,   /* characterized as -20.4 dBm in datasheet */
  /* -21 dBm */   0x0C
};
#else /* HAL_MCU_CC2533 */
const uint8 CODE macRadioDefsTxPwrBare[] =
