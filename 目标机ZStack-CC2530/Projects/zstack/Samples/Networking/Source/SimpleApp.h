...
/* device type */
#define DEV_ID_COLLECTOR                  0
#define DEV_ID_SENTEMP                    1
#define DEV_ID_LIGHT                      2
#define DEV_ID_SWITCH                     3   /**/ 
#define DEV_ID_SENIFR                     4
#define DEV_ID_SENCO2                     5


/* commands */
#define ID_CMD_READ_REQ                   0x0001
#define ID_CMD_READ_RES                   0x8001

#define ID_CMD_WRITE_REQ                  0x0002
#define ID_CMD_WRITE_RES                  0x8002

#define ID_CMD_REPORT                     0x0003
